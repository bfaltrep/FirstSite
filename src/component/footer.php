    ...
    <footer>
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>Made by <?php echo "<a href=\"".$siteCreatorLink."\""; ?> rel="nofollow"><?php echo "$siteCreatorName"; ?></a> in 2017. Contact at <?php echo "<a href=\"mailto:".$siteAddress."\">".$siteAddress."</a>"; ?> .</p>
